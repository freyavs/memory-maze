...
def main():
    ...
    #parser.add_argument('--env', type=str, default='memory_maze:MemoryMaze-13x13-ExtraObs-Top-v0')
    parser.add_argument('--env', type=str, default='memory_maze:MemoryMaze-custom-discrete-ExtraObs-v0')
